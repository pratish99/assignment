    ...
    <>
        <div className='calculator'>
            <div className="container">
                ...
                <button className="action-button" onClick={clearEnd}>CE</button>
                <button className="action-button" onClick={clear}>C</button>
                <button className="action-button" onClick={back}>&#x232b;</button>
                <button className="action-button" onClick={getValue} value="/">/</button>
                ...
                <button className="action-button" onClick={getValue} value=".">.</button>
                <button className="action-button" onClick={calculation}>=</button>
            </div>   
        </div>
    </>
    )
